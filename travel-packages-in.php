                  ...
                  <div class="carousel-item active">
                    <div class="card-deck" id="card">
                      ...
                      <div class="card border-secondary">
                        ...
                        <form action="php/orders/add01.php" method="post">
                          <button type="submit" class="btn btn-md" id="newsBtn">
                            Buy Now
                          </button>
                          </form>
                        </div>
                      ...
                      <div class="card border-secondary">
                        ...
                        <div class="card-footer" id="card-footer">
                        <form action="php/orders/add02.php" method="post">
                          <button type="submit" class="btn btn-md" id="newsBtn">
                            Buy Now
                          </button>
                          </form>
                      ...
                      <div class="card border-secondary">
                        ...
                        <div class="card-footer" id="card-footer">
                        <form action="php/orders/add03.php" method="post">
                          <button type="submit" class="btn btn-md" id="newsBtn">
                            Buy Now
                          </button>
                          </form>
                      ...
                      <div class="card border-secondary">
                        ...
                        <div class="card-footer" id="card-footer">
                        <form action="php/orders/add04.php" method="post">
                          <button type="submit" class="btn btn-md" id="newsBtn">
                            Buy Now
                          </button>
                          </form>
                  ...
                  <div class="carousel-item">
                    <div class="card-deck" id="card">
                      ...
                      <div class="card border-secondary">
                        ...
                        <div class="card-footer" id="card-footer">
                        <form action="php/orders/add05.php" method="post">
                          <button type="submit" class="btn btn-md" id="newsBtn">
                            Buy Now
                          </button>
                          </form>
                      ...
                      <div class="card border-secondary">
                        ...
                        <div class="card-footer" id="card-footer">
                        <form action="php/orders/add06.php" method="post">
                          <button type="submit" class="btn btn-md" id="newsBtn">
                            Buy Now
                          </button>
                          </form>
                      ...
                      <div class="card border-secondary">
                        ...
                        <div class="card-footer" id="card-footer">
                        <form action="php/orders/add07.php" method="post">
                          <button type="submit" class="btn btn-md" id="newsBtn">
                            Buy Now
                          </button>
                          </form>
                      ...
                      <div class="card border-secondary">
                        ...
                        <div class="card-footer" id="card-footer">
                        <form action="php/orders/add08.php" method="post">
                          <button type="submit" class="btn btn-md" id="newsBtn">
                            Buy Now
                          </button>
                          </form>
                  ...
                  <div class="carousel-item">
                    <div class="card-deck" id="card">
                      ...
                      <div class="card border-secondary">
                        ...
                        <div class="card-footer" id="card-footer">
                        <form action="php/orders/add09.php" method="post">
                          <button type="submit" class="btn btn-md" id="newsBtn">
                            Buy Now
                          </button>
                          </form>
                      ...
                      <div class="card border-secondary">
                        ...
                        <div class="card-footer" id="card-footer">
                        <form action="php/orders/add10.php" method="post">
                          <button type="submit" class="btn btn-md" id="newsBtn">
                            Buy Now
                          </button>
                          </form>
                      ...
                      <div class="card border-secondary">
                        ...
                        <div class="card-footer" id="card-footer">
                        <form action="php/orders/add11.php" method="post">
                          <button type="submit" class="btn btn-md" id="newsBtn">
                            Buy Now
                          </button>
                          </form>
                      ...
                      <div class="card border-secondary">
                        ...
                        <div class="card-footer" id="card-footer">
                        <form action="php/orders/add12.php" method="post">
                          <button type="submit" class="btn btn-md" id="newsBtn">
                            Buy Now
                          </button>
                          </form>
